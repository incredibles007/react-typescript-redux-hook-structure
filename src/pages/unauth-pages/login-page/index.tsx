...
function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    const loginSuccess = await userLogin({ email: email, password: password });
      ...
      <div className="flex mx-auto py-6 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-6xl">
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <a href="void(0)" className="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or login with email</a>
          ...
          <a href="void(0)" className="text-xs text-gray-500 dark:text-gray-300 hover:underline">Forget Password?</a>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <a href="void(0)" onClick={(e: any) => onSignUp(e)} className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a>
